                        ...
                        <SplideSlide key={i} className="mb-0.5">
                            <div className='relative grid items-center gap-4 pb-4 rounded-lg shadow shadow-slate-200 ring-1 ring-slate-200 '>
                                <div className='flex items-center justify-center'>
                                    <img className='w-full h-auto object-cover shadow-md shadow-slate-200 rounded-tl-lg rounded-tr-lg' src={val.img} alt="img/story" />
                                </div>
                                ...
                                <div className='flex items-center justify-center px-4 w-full'>
                                    <a target='_blank' className='w-full bg-gradient-to-b from-slate-900 to-gray-900 shadow-md shadow-black text-center text-slate-100 py-1.5 button-theme' href={val.url}>{val.btn}</a>
                                </div>
                            </div>
                        </SplideSlide>
                    ))}
